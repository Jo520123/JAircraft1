...
public class FlightPlan {
    ...
    FlightPlan(String departure, String destination, LocalDateTime departureTime, List<String> route) {
        ...
        System.out.println(String.format("FlightPlan( %s, %s, %s, %s)", departure, destination, departureTime.toLocalTime(), route.toString()));
    ...
    public void print() {
        String message =
                "{" + "id= ' " + this.id + '\'' + "departure=' " + this.departure + '\'' + " , destination=' " + this.destination + '\'' + ", departureDataTime=" + this.departureTime + ", route=" + this.route + '}';
